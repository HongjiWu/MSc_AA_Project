...
class DataReader:
    def __init__(self, data_path: str,
        ...
        self.aux_data = pd.read_csv(subreddit_data_path, usecols=["user", "text", "subreddit", "id", "feature_sim",
                                                "bert_sim", "sim_metric_feature", "sim_metric_bert"],
                                                dtype={"user": "str", "text": "str", "subreddit": "str",
                                                    "id": "str", "feature_sim" : "float", "bert_sim" : "float",
                                                    "sim_metric_feature" : "str", "sim_metric_bert" : "str"
    ...
    def subsample_split_df(self,
        ...
        for user in subset:
            ...
            train_len = self.min_samples_per_author - 1
        ...
        if sim_metric == "feature":

            intermediate_aux = intermediate_aux[intermediate_aux['sim_metric_feature'] == sim_level]
        else:
            intermediate_aux = intermediate_aux[intermediate_aux['sim_metric_bert'] == sim_level]
        logging.info(sim_metric)
        logging.info(sim_level)
        ...
        logging.info(str(test_aux_df['sim_metric_feature']))
        logging.info(str(test_aux_df['sim_metric_bert']))
