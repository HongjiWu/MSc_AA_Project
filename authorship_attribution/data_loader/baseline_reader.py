...
class DataReader:
    def __init__(self, data_path: str,
        ...
        """
        This is the reader design for the baseline experiment which would take processed samples from
        anchor subreddit(file with path as data_path), and auxiliary subreddit(file with path as subreddit_data_path),
        pairing and spliting them in training and testing datasets, then output those results to
        baseline_experiment module



        :param data_path: path to the source dataframe (formatted csv file) with samples from anchor subreddit
        :param subreddit_data_path: path to the source dataframe (formatted csv file) with sample
        from auxiliary subreddits
