...
class BertHybridMethod(BaseAAMethod):
    ...
    def fit_model(self, train_features, train_labels):
        ...
        tracemalloc.start()
        model = ClassificationModel('bert', 'bert-base-cased', num_labels=len(set(train_labels)), args={ 'overwrite_output_dir': True, 'use_early_stopping' : True,  'use_multiprocessing' : False, 'use_multiprocessing_for_evaluation' : False, 'num_train_epochs' : 32, 'train_batch_size' : 5}, use_cuda=True)
