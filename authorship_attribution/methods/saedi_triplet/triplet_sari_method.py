...
from authorship_attribution.methods.saedi_triplet.saedi_network import ContinuousNGramEmbeddingNet
...
class TripletSariMethod(BaseAAMethod):
    def __init__(self,
    ...
    def fit_model(self, train_features, train_labels):
        ...
        self.triplet_model = ContinuousNGramEmbeddingNet(embedding_dim=self.embedding_dim,
